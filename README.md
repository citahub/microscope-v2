...
# Run
  ...
  * Prerequisite
    ...
    There may be problems with the above configuration. If yarn install or yarn start have problems during the compilation phase, you can try again according to the following configuration:
