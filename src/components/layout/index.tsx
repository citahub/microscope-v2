...
export default class Layout extends React.Component<Props, State> {
  ...
  render() {
    ...
    if (hasDrawer) {
      ...
      if (this.state.drawerOpen) {
        ...
        layoutHasDrawerStyle = {
          ...
          transform:
            'translateX(' +
            (this.props.drawerStyle ? this.props.drawerStyle.width : '80%') +
            ')'
        }
        style = {
          ...outTransition,
      ...
      drawerUI = (
        <div
          ...
          style={{ ...style, ...this.props.drawerStyle }}
        >
          {this.props.drawer}
        </div>
      )
    ...
    if (hasDrawer) {
      drawerSwitch = (
        <div
          className="layout_drawer_menu"
          onClick={this.switchDrawer.bind(this)}
        >
          <svg
      ...
      <div
        className={
          this.props.className
            ? 'layout_container ' + this.props.className
            : 'layout_container'
        }
      >
        <div
          ...
          onFocus={this.closeDrawer.bind(this)}
        >
          {drawerSwitch}
          {this.props.children}
        </div>
