...
const jsonRpc =[
  ...
  {
    name: '/api/blocks',
    inputSample: '{"numberFrom":"10","numberTo":"20","transactionFrom":"1","transactionTo":"100","page":"1","perPage":"10","offset":"1","limit":"10"}'
  },
  {
    name: '/api/transactions',
    inputSample: '{"account":"0x46f8bf24c777fee056d447f3869ee5f71b37d0e3","from":"0x46f8bf24c777fee056d447f3869ee5f71b37d0e3","to":"0xffffffffffffffffffffffffffffffffff010001","valueFormat":"decimal","page":"1","perPage":"10","offset":"1","limit":"10"}'
  },
  {
  ...
  },
  {
    ...
    inputSample: '{"address":"0x...","account":"from or to","from":"from address","to":"to address","page":1,"perPage":10,"offset":1,"limit":10}'
  },
  {
                ...
                <div className="card" style={{ height: '40%'}}>
                   ...
                   <div className="card-footer" style={{ textAlign: 'right'}}>
                     <button className="btn btn-danger" onClick={()=>{
                       ...
                       console.log(input);
                       try{
                         self.props.networkAction.rebirth(getSelectNetwork().url + method,JSON.parse(input||"{}"));
                  ...
                  <div className="card-header">
                   ...
                   <div className="card-body">
                     <div ref='output' style={{ width: '100%', minHeight: 200}}>
                        <ReactJson src={self.props.network.rebirthData.output ||{} } />
                     </div>
                   </div>
