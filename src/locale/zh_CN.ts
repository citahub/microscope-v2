...
const zh_CN = {
  ...
  'app.footer.category.introcution':
    'Microscope 为 CITA 提供简单易用的用户界面.',
  'app.footer.category.tech': '技术',
  'app.footer.category.contact': '联系我们',
  'app.footer.category.contact.bbs': 'CITAHub 开发者论坛',
  ...
  'app.pages.home.top10.block': '最近10个块',
  ...
  'app.pages.blocklist.search.parameters':
    '当前搜索参数:  区块起始{blockFrom}, 区块截止{blockTo}, 最小交易数{transactionCountMin}, 最大交易数{transactionCountMax}',
  'app.pages.blocklist.search.button': '高级选择器',
  'app.pages.blocklist.table.header.height': '块高',
  'app.pages.blocklist.table.header.hash': '哈希',
  'app.pages.blocklist.table.header.timestamp': '出块时间',
  'app.pages.blocklist.table.header.txcount': '交易数',
  'app.pages.blocklist.table.header.quotaused': 'Quota消耗',
  ...
  'app.pages.txdetail.from': '从',
  'app.pages.txdetail.to': '至/合约地址',
  'app.pages.txdetail.blockheight': '块高',
  ...
  'app.pages.static.interval': '最新10块的出块时间趋势',
  'app.pages.static.txcount': '最新10块的交易数量趋势',
  'app.pages.static.quotainblock': '最新10块的Quota消耗',
  'app.pages.static.quotaintx': '最新10交易的Quota消耗',
  ...
  'app.pages.common.transactiontable.header.type': '交易类型',
  'app.pages.common.transactiontable.header.hash': '哈希',
  'app.pages.common.transactiontable.header.from': '从',
  'app.pages.common.transactiontable.header.to': '至',
  'app.pages.common.transactiontable.header.value': '价值',
  'app.pages.common.transactiontable.header.blockheight': '区块',
  'app.pages.common.transactiontable.header.quotaused': '消耗的 Quota',
  'app.pages.common.transactiontable.header.timestamp': '时间',

  'app.pages.common.blocksearchmodal.title': '高级选择器',
  'app.pages.common.blocksearchmodal.blockheight': '块高范围',
  'app.pages.common.blocksearchmodal.blockheight.from': '起始块高',
  'app.pages.common.blocksearchmodal.blockheight.to': '截止块高',
  'app.pages.common.blocksearchmodal.txscount': '交易量范围',
  'app.pages.common.blocksearchmodal.txscount.min': '交易数最小值',
  'app.pages.common.blocksearchmodal.txscount.max': '交易数最大值',
